...
- **怎么改善样本不均衡？Focal loss？**
    ...
    ![Untitled](https://prod-files-secure.s3.us-west-2.amazonaws.com/0854110e-ae60-49a4-be8c-e3cb3183db85/e1e08ea2-9818-4140-9491-db246b60799d/Untitled.png)
...
- **Llama2 的网络详解**
    ...
    ![Untitled](https://prod-files-secure.s3.us-west-2.amazonaws.com/0854110e-ae60-49a4-be8c-e3cb3183db85/9e7040a4-d49c-433e-8db8-77c6cb29e258/Untitled.png)
    
- **常用激活函数**
    1. ****Gaussian Error Linerar Units(GELUS)****
    ...
    2. GLU(x) = x ⊗ σ(g(x))。其中，x是输入向量，⊗表示逐元素相乘，σ表示Sigmoid函数，g(x)是通过全连接层或卷积层得到的中间向量。
- RoPE旋转位置编码

![Untitled](https://prod-files-secure.s3.us-west-2.amazonaws.com/0854110e-ae60-49a4-be8c-e3cb3183db85/ebfcbd76-2445-4c4b-860a-374915d3e2c5/Untitled.png)

- **pre-norm和post-norm的区别？**
    
    ![Untitled](https://prod-files-secure.s3.us-west-2.amazonaws.com/0854110e-ae60-49a4-be8c-e3cb3183db85/2b9abc22-e04d-4089-bdab-13025e52d71c/Untitled.png)
